...
import ParticlesViedo from './ParticlesViedo';
const Home = () => {
    const [isHovered, setIsHovered] = useState(false);
    const text = Typewriter({
        words: [' Frontend Developer', 'Web Developer', 'Mern Stack Developer', 'React Developer'],
        loop: {}

    })
    return (
        <>
        <ParticlesViedo></ParticlesViedo>
            <div>


                <section className="dark:bg-gray-800 dark:text-gray-100">
                    <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
                        <div className='pt-20 ml-10 text-white'>
                            <h1 className='text-5xl font-semibold' style={{ margin: '50px' }}>
                                <p className='text-primary text-2xl'>Hi !</p>

                                <p className='text red-600'>I’M SHAHJHAN MIAH</p>
                                I am
